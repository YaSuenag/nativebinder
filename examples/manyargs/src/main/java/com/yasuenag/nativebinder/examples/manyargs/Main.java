...
public class Main{
  ...
  public native int intManyArgs(boolean a1,
                                byte a2,
                                char a3,
                                short a4,
                                int a5,
  ...
  public native int fpManyArgs(float a1,
                               double a2,
                               float a3,
                               double a4,
                               float a5,
  ...
  public native int mixManyArgs(boolean a1,
                                float a2,
                                char a3,
                                double a4,
                                int a5,
  ...
  public static void main(String[] args) throws Throwable{
    ...
    result = inst.intManyArgs(true, (byte)2, (char)3, (short)4, 5, 6L,
    ...
    result = inst.fpManyArgs(0.1f, 0.2d, 0.3f, 0.4d, 0.5f, 0.6d, 0.7f, 0.8d,
    ...
    result = inst.mixManyArgs(true, 0.2f, (char)3, 0.4d, 5, 0.6f, 7L, 0.8d, (byte)9,
